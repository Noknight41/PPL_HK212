...
class LexerSuite(unittest.TestCase):
   ...
   def test_148(self):
      test = """-0xFFFF 0XFFFF 0xffff 0XFFFF 0XZZZZ 0xzzzz 0B1111 !True && False +. 2"""
      exp = """-,0xFFFF,0XFFFF,0,xffff,0XFFFF,0,XZZZZ,0,xzzzz,0B1111,!,True,&&,False,+.,2,<EOF>"""
      self.assertTrue(TestLexer.test(test,exp,148))
   
   def test_149(self):
      test = 'Var a: String = b +. "Welcome to Hell \'course";'
      expect = 'Var,a,:,String,=,b,+.,Welcome to Hell \'course,;,<EOF>'
   ...
   def test_160(self):
      test = """ "This string is valid" "That string is kay' " "This string is also okay '" " "This string is an unclosed string'" """
      exp = """This string is valid,That string is kay' ,This string is also okay '" ,Unclosed String: This string is an unclosed string'" """
   ...
   def test_166(self):
      test = """ "ddkjlsdjkh String with '"quote'" and has comment ##abcd##" """
      exp = """ddkjlsdjkh String with '"quote'" and has comment ##abcd##,<EOF>"""
   ...
   def test_189(self):
      test = """ 0x123456789abcdef -0x123456789abcdef 00xffff +0x123456789abcdef +0b10101010 01234 % 01234 +0b10101010"""
      exp = """0x123456789,abcdef,-,0x123456789,abcdef,00,xffff,+,0x123456789,abcdef,+,0b10101010,01234,%,01234,+,0b10101010,<EOF>"""
   ...
   def test_195(self):
      ...
      Array (
         Array("Oppo", "22", "18"),
         Array("Lanovert Kao", "17", "15"),
         Array("Xiaomi", "5", "2"),
         Array("Ford", "21001", "asjdah")
         Array (True, False, True)
      )"""
      exp = """Array,(,Array,(,Oppo,,,22,,,18,),,,Array,(,Lanovert Kao,,,17,,,15,),,,Array,(,Xiaomi,,,5,,,2,),,,Array,(,Ford,,,21001,,,asjdah,),Array,(,True,,,False,,,True,),),<EOF>"""
   ...
   def test_198(self):
      test = """
            ...
            0xFFF.123e123
      """
      exp = "1.234,01,.,234,00,1.234,1.0123,1.00123,1.,1.0,1e123,1e0123,1e00123,1e+123,1e+0123,1e+00123,1e-123,1e-0123,1e-00123,1123.123e123,1123.123e123,1123.1,_2_3e123,1123123e1,_2_3,1123123,_e1_2_3,123.123e123,123.000123e000123,0,_1_2_3,.123e123,0b111,.123e123,0xFFF,.123e123,<EOF>"
   ...
   def test_200(self):
      test = """2_453_344 Boolean Return xVsygC71n5:: ==>= ||Destructor <= <## ::! >=Boolean :::: ||== ::<= >=:: #### ::<= ||## ##>= >=>= Break== <=:: Destructor"""
      exp = """2453344,Boolean,Return,xVsygC71n5,::,==,>=,||,Destructor,<=,<,Error Token #"""
