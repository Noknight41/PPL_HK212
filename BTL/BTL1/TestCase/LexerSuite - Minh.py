...
class LexerSuite(unittest.TestCase):
   ...
   # Integer
    ...
    def test_floating_2(self):
        self.assertTrue(TestLexer.test("1.2e3 90E3 12E+1_24_00", "1.2e3,90E3,12E+12400,<EOF>", 122))
    ...
    def test_floating_5(self):
        self.assertTrue(TestLexer.test("1_2.5e-3_4", "12.5e-34,<EOF>", 125))
    def test_floating_6(self):
        self.assertTrue(TestLexer.test("1_2.3_4", "12.34,<EOF>", 126))
    def test_floating_7(self):
        self.assertTrue(TestLexer.test("1_2.01e-1_1", "12.01e-11,<EOF>", 127))
   ...
   # More test
    ...
    def test_more_6(self):
        inp = """ 
            qA_ kMG4__f2I_zy XdPL50B-0B%E +9e-_ 
        """
